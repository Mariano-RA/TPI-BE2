      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          let successAlert =
            ...
            "<strong> Se actualizaron los datos del Odontologo </strong></div>";

          $("#tr_" + odontologoId + " td.td_nombre").text(
            odontologo.nombre.toUpperCase()
          );
          $("#tr_" + odontologoId + " td.td_apellido").text(
            odontologo.apellido.toUpperCase()
          );
          $("#tr_" + odontologoId + " td.td_matricula").text(
